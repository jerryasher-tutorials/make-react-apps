...
const api_id = `4YBNWI4SXR`;
const api_key = `34265bd5abe239d41831f1f5a381070d`;
...
function Product({ hit }) {
  return (
    <a className="product" href={hit.url} target="_blank">
      <img rel="noopener noreferrer" src={hit.image} alt={hit.name} />
      <div>
        <h3>{hit.brand}</h3>
        <h2>{hit.name}</h2>
        <p>${hit.price}</p>
